...
const Contact = () => {
    ...
    if (state.succeeded) {
        return (
            <div data-aos="fade-up" className="p-4 lg:p-20 flex flex-col items-center justify-center">
                <h1 className="text-[52px] text-center font-semibold mb-15 leading-normal uppercase text-red-500">Excellent!</h1>
